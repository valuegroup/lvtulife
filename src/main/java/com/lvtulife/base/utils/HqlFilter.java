 ...
 * t#id 就是t.id
 * <p/>
 * S:String L:Long I:Integer D:Date ST:Short BD:BigDecimal FT:Float BT:Byte
 * <p/>
 * EQ 是操作符
 * <p/>
...
public class HqlFilter {
    ...
    public void addFilter(String name, byte value) {
        this.addFilter(name, Byte.toString(value));
    }

    public void addFilter(String name, int value) {
        this.addFilter(name, Integer.toString(value));
    }
    ...
    private Object getObjValue(String columnType, String operator, String value) {
        ...
        if (StringUtils.equalsIgnoreCase(columnType, "BT")) {
